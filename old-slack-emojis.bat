...
>"%SLACK_DIR%\old-slack-emojis.js" (
    ...
    ECHO.emojiStyle.innerText = ".emoji-sizer[style*='sheet_google_64_indexed_256.png'] { background-image: url('https://github.com/pwnclub/old-slack-emojis/raw/master/slack_2016_apple_sprite_64.png') !important; }";
